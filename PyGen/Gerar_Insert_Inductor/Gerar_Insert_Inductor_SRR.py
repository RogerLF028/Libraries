...
def gerar_insert(series, dados, start_mypn, output_file, symbol):
    ...
    for part, ind, irms, dcr in dados:
        ...
        if series == "SRR1208":
            footprint = f"MyLib_Inductor_SMD:L_Bourns_SRR1208_12.7x12.7mm"
        elif series == "SRR1210":
            footprint = f"MyLib_Inductor_SMD:L_Bourns_SRR1210A"
        else:
            footprint = f"MyLib_Inductor_SMD:L_Bourns_SRR1260"
...
# SRR1260
prox = gerar_insert("SRR1260", dados_srr1260, prox, OUTPUT_SRR1260, "MyLib_Inductor:L_Ferrite")

# SRR1208
prox = gerar_insert("SRR1208", dados_srr1208, prox, OUTPUT_SRR1208, "MyLib_Inductor:L_Ferrite")

# SRR1210
prox = gerar_insert("SRR1210", dados_srr1210, prox, OUTPUT_SRR1210, "MyLib_Inductor:L_Ferrite")
